load("~/Documents/Adobe/Rcodesd/MNIST_RVM.RData")
source('~/Documents/Adobe/Rcodesd/RVM_Cascade.SVM.R')
source('~/Documents/Adobe/Rcodesd/rvmpmtest.R')
source('~/Documents/Adobe/Rcodesd/rvm_w_MP.R')
